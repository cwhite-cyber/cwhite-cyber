...
- 📄 **Portfolio** — documenting everything with READMEs that explain not just 
  what I did but why it works and what broke along the way

## Skills

**Operating Systems:** Linux (Ubuntu Server, Kali), Windows  
...
10+ years in customer support across AT&T, healthcare, and 
telecommunications — built strong instincts for systematic 
troubleshooting, clear documentation, and working through problems 
methodically. Applying all of it to cybersecurity.

---
*Based in Pueblo West, CO — open to remote roles.*
